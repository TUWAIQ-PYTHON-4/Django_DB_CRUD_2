...
class Publisher(models.Model):
   ...
   def __str__(self):
      return self.name,self.email,self.website

class Contributor(models.Model):
   first_name = models.CharField(max_length=50, help_text="The contributor's first name.")
   last_name = models.CharField(max_length=50, help_text="Thecontributor's last name or name.")
...
class Review(models.Model):
   ...
   rating = models.IntegerField(help_text="The rating the rev iewer has given.")
   ...
   movie = models.ForeignKey(Movies_Info, on_delete=models.CASCADE,
                             help_text = "The Movie that this re view  is for .")
