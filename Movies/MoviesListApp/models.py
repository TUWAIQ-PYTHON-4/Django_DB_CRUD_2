...
class Publisher(models.Model):
    name = models.CharField(max_length=50, help_text="The nameof the Publisher.")
    website = models.URLField(help_text="The Publisher's website.")
    email = models.EmailField(help_text="The Publisher's email address.")

    def __str__(self):
        return self.name + ' ' + self.website + ' ' + self.email
...
class Movies_Info(models.Model):
    ...
    def __str__(self):
        return self.name + ' ' + self.date + ' ' + self.publisher
